...
export const ENRICHMENT: Record<string, Enrichment> = {
  ...
  'faq-04': {
    ...
    keywords: [
      'private', 'vehicle', 'gaadi', 'car', 'ndmc', 'resident', 'movement', 'restriction', 'road',
    ],
    volatility: 'stable',
  },
  'faq-05': {
  ...
  'faq-06': {
    ...
    keywords: ['metro', 'airport', 'express', 'line', 'better', 'option', 'road', 'traffic'],
    volatility: 'stable',
  },
  'faq-07': {
    intentId: 'airport_rail_travel',
  ...
  'faq-08': {
    ...
    keywords: [
      'railway', 'station', 'ndls', 'new', 'delhi', 'train', 'khula', 'open', 'diversion', 'route',
    ],
    volatility: 'stable',
  },
  'faq-09': {
  ...
  'faq-12': {
    ...
    keywords: [
      'admit', 'card', 'restricted', 'road', 'entry', 'proof', 'exam', 'permission', 'barricade',
    ],
    volatility: 'stable',
  },
  'faq-13': {
  ...
  'faq-17': {
    ...
    keywords: [
      'inter', 'state', 'interstate', 'bus', 'isbt', 'entry', 'delhi', 'passenger', 'rajya',
    ],
    volatility: 'volatile',
  },
  'faq-18': {
    ...
    keywords: ['auto', 'taxi', 'rickshaw', 'chalega', 'restricted', 'controlled', 'movement'],
    volatility: 'stable',
  },
  'faq-19': {
    intentId: 'public_transport',
    ...
    keywords: [
      'ola', 'uber', 'cab', 'app', 'book', 'pickup', 'driver', 'rapido', 'ride', 'available',
    ],
    volatility: 'stable',
  },
  'faq-20': {
    ...
    keywords: [
      'swiggy', 'zomato', 'blinkit', 'zepto', 'delivery', 'food', 'khana', 'order', 'online', 'grocery',
    ],
    volatility: 'stable',
  },
  'faq-21': {
  ...
  'faq-23': {
    ...
    keywords: [
      'truck', 'interstate', 'entry', 'divert', 'diversion', 'notification', 'alternate', 'route', 'bahar',
    ],
    volatility: 'volatile',
  },
  'faq-24': {
  ...
  'faq-26': {
    ...
    keywords: ['utarna', 'step', 'out', 'vehicle', 'gaadi', 'vip', 'movement', 'lane', 'safe'],
    volatility: 'stable',
  },
  'faq-27': {
    intentId: 'vip_movement',
  ...
  'faq-28': {
    ...
    keywords: [
      'barricade', 'hatana', 'restricted', 'road', 'cross', 'bypass', 'alternate', 'route',
    ],
    volatility: 'stable',
  },
  'faq-29': {
    ...
    keywords: [
      'rasta', 'route', 'band', 'closed', 'blocked', 'alternate', 'advisory', 'diversion', 'achanak',
    ],
    volatility: 'stable',
  },
  'faq-30': {
    ...
    keywords: [
      'google', 'maps', 'navigation', 'app', 'gps', 'bharosa', 'trust', 'route', 'update', 'advisory',
    ],
    volatility: 'stable',
  },
  'faq-31': {
  ...
  'faq-34': {
    ...
    keywords: [
      'jam', 'traffic', 'congestion', 'stuck', 'phasna', 'intersection', 'lane', 'alternate',
    ],
    volatility: 'stable',
  },
  'faq-35': {
  ...
  'faq-36': {
    ...
    keywords: ['wrong', 'side', 'galat', 'ulti', 'disha', 'driving', 'accident', 'jam', 'illegal'],
    volatility: 'stable',
  },
  'faq-37': {
    intentId: 'road_conduct_jams',
  ...
  'faq-39': {
    ...
    keywords: [
      'blocking', 'ambulance', 'rokna', 'emergency', 'report', 'inform', '112', '1095', 'danger',
    ],
    volatility: 'stable',
  },
  'faq-40': {
  ...
  'faq-45': {
    ...
    keywords: [
      'hotel', 'venue', 'summit', 'entry', 'authorization', 'route', 'timing', 'controlled', 'area',
    ],
    volatility: 'stable',
  },
  'faq-46': {
  ...
  'faq-48': {
    ...
    keywords: [
      'achanak', 'sudden', 'stopped', 'police', 'barricading', 'bypass', 'instruction', 'vip', 'security',
    ],
    volatility: 'stable',
  },
  'faq-49': {
  ...
  'faq-50': {
    ...
    keywords: [
      'social', 'media', 'whatsapp', 'forward', 'fake', 'galat', 'khabar', 'rumour', 'verify', 'panic',
    ],
    volatility: 'stable',
  },
  'faq-51': {
  ...
  'faq-52': {
    ...
    keywords: [
      'violation', 'report', 'illegal', 'parking', 'signal', 'encroachment', 'wrong', 'side', 'action', 'shikayat',
    ],
    volatility: 'stable',
  },
  'faq-53': {
  ...
  'faq-58': {
    ...
    keywords: [
      'check', 'checking', 'tyre', 'brake', 'battery', 'lights', 'document', 'vehicle', 'maintenance',
    ],
    volatility: 'stable',
  },
  'faq-59': {
    ...
    keywords: [
      'rules', 'breaking', 'todna', 'confrontation', 'behas', 'argue', 'danger', 'report', 'safe', 'distance',
    ],
    volatility: 'stable',
  },
  'faq-60': {
